...
6. **Public API Contract**: Exactly 101 public symbols are exported in jnwb.__all__. Never break or alter existing public signatures without an approved transition plan.
